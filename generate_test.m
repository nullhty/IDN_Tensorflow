...
h5create('test_IDN.h5','/data',size(data),'Datatype','single');
h5create('test_IDN.h5','/label',size(label),'Datatype','single');

h5write('test_IDN.h5','/data',data);
h5write('test_IDN.h5','/label',label);